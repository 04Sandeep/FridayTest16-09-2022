...
public class AddShoesToCart {
    ...
    By clickonApparel = By.xpath("//a[contains(text(),'Apparel)]");
    By clickonitem = By.xpath("//a[contains(text(),'Nike Floral Roshe Customized Running Shoes')]");
    By clickonshoes = By.xpath("//a[@title = 'Show products in category Apparel']");
