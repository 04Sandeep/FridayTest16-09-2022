...
public class AddJewelryToCart {
    ...
    By clickonJewelery = By.xpath("//a[contains(text(),'Jewelry')]");
    By clickonitem = By.xpath("//a[contains(text(),'Flower Girl Bracelet')]");
    ...
    public void addJewelryToCart()
    {
        ...
        driver.findElement(clickonJewelery).click();
